...
import { motion, TargetAndTransition, useScroll, useTransform, Variants } from "framer-motion"
...
import { SiDjango, SiExpress, SiTypescript, SiReact, SiMongodb, SiNodedotjs, SiNextdotjs } from "react-icons/si"
...
const services = [
  { title: "Full-Stack Development", icon: Globe, description: "End‑to‑end web applications" },
  { title: "Backend APIs", icon: Server, description: "Scalable server solutions" },
  { title: "Database Design", icon: Database, description: "Optimized data architecture" },
  { title: "Server Architecture", icon: Cpu, description: "Robust server infrastructure" },
]
...
export default function Hero() {
  ...
  const titles = useMemo(() => ["Full Stack Developer", "Backend Engineer", "Tech Enthusiast"], []);
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div className="relative z-10 container mx-auto px-4 py-16" style={{ y: textY }}>
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div className="text-center mb-16" variants={containerVariants} initial="hidden" animate="visible">
            ...
            >
              ...
              scalable, user‑centric applications. From concept to deployment, I bring ideas to life with clean code and
            ...
            >
              {[
                { icon: Github, href: "https://github.com/abhishek-mehta-dev", label: "GitHub" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/abhishek-mehta-0724ab256/", label: "LinkedIn" },
          ...
          <motion.div
            ...
            variants={containerVariants}
          >
            <motion.h3 className="text-2xl font-semibold text-white mb-8" variants={fadeInUp} custom={0}>
      ...
      <style jsx>{`
        @keyframes float {
          ...
          33% { transform: translateY(-15px) rotate(120deg) scale(1.1); opacity:0.8; }
          66% { transform: translateY(-5px) rotate(240deg) scale(0.9); opacity:0.7; }
        }
