...
export default function Projects() {
  ...
  description:
    "Full-stack subscription training platform centered on the 30-Day Reset program, with course delivery, quizzes, certificates, community features, and automated billing workflows.",
  ...
  responsibilities: [
    "Architected and built a modular NestJS backend for a subscription-based dog training platform with scalable domain modules.",
    "Implemented secure authentication with JWT access/refresh cookies, route guards, role-based authorization, and password recovery flows.",
    "Developed end-to-end LMS capabilities including course/module/lesson APIs, progress tracking, quiz gating, and student dashboard metrics.",
    "Built certification workflows with eligibility checks, certificate PDF generation, download endpoints, and automated certificate email notifications.",
    "Engineered a community system with category management, discussion posts, threaded comments, and admin moderation endpoints.",
    "Implemented plan-based subscriptions and access control across training, portal, and one-time digital-product offerings.",
    "Integrated Stripe and PayPal payment gateways with checkout verification, payment method vaulting, lifecycle tracking, and reconciliation utilities.",
    "Built recurring billing and subscription lifecycle automation using scheduled jobs for renewals, revocations, and stale-payment sweeps.",
    "Developed invoice generation and billing history pipelines with downloadable PDFs and transaction-linked records.",
    "Implemented cloud media workflows using AWS S3 uploads, CloudFront-secured playback, and HLS transcoding/backfill support for lesson videos.",
    "Created operational tooling and migration scripts for seeding curriculum, normalizing media paths, and maintaining production data integrity.",
    "Maintained quality and maintainability through typed DTOs/entities, test coverage for critical utilities, and OpenAPI-documented APIs.",
  ],
},
    {
  ...
  responsibilities: [
    ...
    {
  title: "VentSpace AI – Real-Time Mental Health Companion Backend",
  description:
    "Production backend for an anonymous AI companion platform with real-time chat, safety intervention workflows, mood tracking, daily summaries, admin analytics, and secure SSO-based admin access.",
  ...
  liveUrl: "https://ai.ventspaceapp.com",
  githubUrl: "#",
  featured: true,
  status: "Live",
  category: "Backend / Real-Time AI",
  gradient: "from-indigo-500 to-cyan-500",
  shadowColor: "rgba(99, 102, 241, 0.3)",
  roles: ["Backend Developer", "Platform Engineer"],
  responsibilities: [
    "Architected and maintained a modular Express + TypeORM backend powering an anonymous AI companion experience for emotional support.",
    "Implemented secure auth integration with external Laravel auth services, token verification middleware, and local user-sync pipelines into the AI service database.",
    "Built SSO session flows for admin access, including one-time code exchange, verify-token validation, HttpOnly cookie session setup, and logout/session endpoints.",
    "Developed real-time messaging infrastructure using Socket.IO with authenticated connections, personal rooms, typing indicators, delivery/read events, and server-side message persistence.",
    "Implemented multi-tier safety pipelines (self-harm, harm-to-others, abuse) with keyword + NLP moderation checks, crisis resource injection, and safety audit logging.",
    "Engineered AI chat and summary workflows using OpenAI APIs, including conversation-context handling, voice transcription support, and nightly AI-generated daily reflection summaries.",
    "Built mood tracking systems with before/after session entries, date-range analytics, graph-ready aggregation, and timezone-aware daily reset behavior.",
    "Created comprehensive admin analytics APIs (dashboard, mood journey, emotional trends, conversation health, crisis metrics, AI insights, research metrics) with range-based filters.",
    "Implemented terms/privacy acknowledgment proof logging and compliance-oriented endpoints for consent status and acceptance records.",
    "Hardened production operations with global rate limiting, health/readiness probes, structured error handling, Swagger docs, cron orchestration, and environment validation.",
    "Reworked WebSocket deployment compatibility by moving Socket.IO to a dedicated /socket path and aligning backend/client/Nginx routing for stable production connectivity.",
    "Maintained operational tooling and migration scripts for seeding, UTC normalization, cleanup tasks, and production-safe data maintenance workflows.",
  ],
},
    {
  title: "Next Level Speed – Subscription Learning & Mentorship Backend",
  description:
    "Modular NestJS backend powering subscription access, training content delivery, elite mentorship enrollment, invoicing, notifications, and admin operations for a sports performance platform.",
  ...
  roles: ["Backend Developer", "Platform Engineer"],
  responsibilities: [
    "Architected a modular NestJS backend with separated domains for auth, plans, subscriptions, billing, LMS content, mentorship, notifications, and support operations.",
    "Implemented secure session authentication using JWT access/refresh tokens in HttpOnly cookies, plus guards for access, refresh, checkout-token, role-based authorization, and active-subscription enforcement.",
    "Built account lifecycle workflows including checkout registration, pending-payment user states, email verification tokens, and automatic stale pending-account cleanup support.",
    "Developed password security flows with forgot-password OTP issuance, resend cooldowns, lockout rules, reset-token verification, and protected password change endpoints.",
    "Implemented plan management and subscription access controls for recurring plans, with plan-type handling (portal, training+portal, mentorship) and lifecycle state transitions.",
    "Integrated Stripe billing for customer creation, payment intents, payment verification, off-session recurring charges, setup intents, payment-method attachment/defaulting, and refunds for capacity conflicts.",
    "Built subscription lifecycle automation including renewal processing, period advancement, cancel/resume auto-renew controls, lapsed-subscription reactivation, and maintenance scheduling via cron.",
    "Implemented mid-cycle plan-change workflows with upgrade/downgrade previews, scheduled downgrades, immediate upgrade charging, idempotent payment handling, and deferred course-access revocation.",
    "Engineered invoicing pipelines by generating transaction-linked invoices, rendering HTML templates to PDF via Handlebars + Puppeteer, and exposing secure invoice listing/download endpoints.",
    "Developed LMS APIs for programs, modules, and video lessons, including enrollment-aware access, lesson completion toggles, playback progress persistence, and admin content CRUD.",
    "Built a dedicated Elite Mentorship purchase flow with seat-capacity constraints, race-condition-safe verification, enrollment lifecycle management, and admin member analytics.",
    "Implemented engagement and ops features including SSE real-time notifications, batched email campaigns for new resources, promo video management, support/FAQ modules, transaction reporting/export, and admin dashboard metrics.",
  ],
},
    {
