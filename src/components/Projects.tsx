  ...
  const projects = [
    {
      ...
      responsibilities: [
        ...
        "Implemented HIPAA-compliant data encryption for Protected Health Information (PHI) storage in database",
        "Applied administrative, technical, and physical safeguards to prevent patient data breaches",
        ...
        "Developed role-based access control (RBAC) for Admins, Agencies, and Nurses with audit logging",
        "Added secure video upload functionality and automated invoice generation",
