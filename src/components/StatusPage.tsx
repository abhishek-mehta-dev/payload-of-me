...
export default function StatusPage({
  ...
  return (
    <section className="relative min-h-[calc(100vh-4rem)] overflow-hidden blueprint-grid noise-overlay flex items-center">
      <div
        className="pointer-events-none absolute -top-32 left-1/2 -translate-x-1/2 w-[50rem] h-[28rem] rounded-full blur-3xl opacity-15"
        style={{ background: "var(--brand)" }}
      />

      <div className="container-responsive relative z-10 py-20 sm:py-28">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-10 flex items-start gap-5">
            <div className="relative shrink-0">
              <div className="flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-lg border border-brand/35 bg-brand/10">
                <Icon className="h-8 w-8 sm:h-9 sm:w-9 text-brand" />
              </div>
